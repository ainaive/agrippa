...
3. **Task submission** — auto-generated form (+ agent-slot pickers for v2 templates) beside a sticky summary card (Faber, pinned template version, usage limits) with the submit action; errors toast.
