...
- **Tests are part of the change**: new endpoints get integration tests (`apps/api/src/test/`); engine semantics changes extend the compliance suite (`packages/orchestration/src/engine/engine.integration.test.ts`).
